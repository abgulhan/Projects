...
"""
Changes: 
Modified plot_maze to change end location as parameter
"""
...
def plot_maze(maze, maze_csv, display_fig=False, save_fig=True, end_location=None):
    """
    Plot the maze
    Args:
        maze (list): The maze
    ...
    if end_location != None:
        modified_maze[end_location[0]][end_location[1]] = 3
    else:
