...
class MazeEnv(gym.Env):
    ...
    def __init__(self, maze_file=None, maze_size=None, mode=None, enable_render=True, goal=None):
...
class MazeHilbert7x7(MazeEnv):

    def __init__(self, enable_render=True):
        super(MazeHilbert7x7, self).__init__(maze_file="maze-hilbert-7x7.npy", enable_render=enable_render, goal=np.array((6,0)) )

class MazeHilbert15x15(MazeEnv):

    def __init__(self, enable_render=True):
        super(MazeHilbert15x15, self).__init__(maze_file="maze-hilbert-15x15.npy", enable_render=enable_render, goal=np.array((14,0)) )
        
class MazeRows7x7(MazeEnv):

    def __init__(self, enable_render=True):
        super(MazeRows7x7, self).__init__(maze_file="maze-rows-7x7.npy", enable_render=enable_render)
        
class MazeRows10x10(MazeEnv):

    def __init__(self, enable_render=True):
        super(MazeRows10x10, self).__init__(maze_file="maze-rows-10x10.npy", enable_render=enable_render)

class MazeRows15x15(MazeEnv):

    def __init__(self, enable_render=True):
        super(MazeRows15x15, self).__init__(maze_file="maze-rows-15x15.npy", enable_render=enable_render)
