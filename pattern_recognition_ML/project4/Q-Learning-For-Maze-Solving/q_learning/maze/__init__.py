...
register(
    ...
    entry_point='maze.maze_env:MazeEnvRandom10x10Plus',
    max_episode_steps=1000000,
    nondeterministic=True,
)
...
register(
    id='maze-hilbert-7x7',
    entry_point='maze.maze_env:MazeHilbert7x7',
    max_episode_steps=1000000,
)

register(
    id='maze-hilbert-15x15',
    entry_point='maze.maze_env:MazeHilbert15x15',
    max_episode_steps=1000000,
)

register(
    id='maze-rows-7x7',
    entry_point='maze.maze_env:MazeRows7x7',
    max_episode_steps=1000000,
)

register(
    id='maze-rows-10x10',
    entry_point='maze.maze_env:MazeRows10x10',
    max_episode_steps=1000000,
)

register(
    id='maze-rows-15x15',
    entry_point='maze.maze_env:MazeRows15x15',
    max_episode_steps=1000000,
)