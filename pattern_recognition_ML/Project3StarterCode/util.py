...
file that you add code to.)
{
    ...
    Description: (A short description of what each of the functions you've written does.).
        Added --model parameter as an argument
        Added --train_size parameter as an argument
        Added --test_size parameter as an argument
        Added --num_workers parameter as an argument
        Added --load_model parameter as an argument
}
'''
import argparse
import os
...
def arg_parse():
    ...
    parser.add_argument('--model', type=str, default='MLP', help='which model to use (MLP, MLP2, or MLP3) for Taiji, (CNN, CNN2) for Wallpaper')
    parser.add_argument('--num_workers', type=int, default=0, help='Number of workers to use when loading data')
    # Taji specific
    ...
    parser.add_argument('--train_size', type=int, default=None, help='Maximum size of train dataset to use')
    parser.add_argument('--test_size', type=int, default=None, help='Maximum size of test dataset to use')
    parser.add_argument('--load_model', type=str, default=None, help='Load model given name')
